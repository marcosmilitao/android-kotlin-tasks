...
class LoginViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val mPersonalRepository = PersonRepository(application)
    ...
    fun doLogin(email: String, password: String) {
        mPersonalRepository.login(email, password, object : APIListener<HeaderModel> {
            override fun onSuccess(model: HeaderModel) {
                ...
                RetrofitClient.adHearder(model.token,model.personKey)
    ...
    fun verifyLoggedUser() {
        ...
        RetrofitClient.adHearder(token,person)
